<template>
  <header>
    <div class="control-aside" @click="$emit('update:showAside', !showAside)">
    ...
    <div class="control-toc" @click="$emit('update:showToc', !showToc)">
      <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        ...
        ></path>
        <path
          d="M128 682.666667m40.106667 0l687.786666 0q40.106667 0 40.106667 40.106666l0 5.12q0 40.106667-40.106667 40.106667l-687.786666 0q-40.106667 0-40.106667-40.106667l0-5.12q0-40.106667 40.106667-40.106666Z"
        ></path>
        <path
          d="M128 256m40.106667 0l687.786666 0q40.106667 0 40.106667 40.106667l0 5.12q0 40.106667-40.106667 40.106666l-687.786666 0q-40.106667 0-40.106667-40.106666l0-5.12q0-40.106667 40.106667-40.106667Z"
        ></path>
      </svg>
    </div>
  </header>
...
defineEmits(['update:showAside', 'update:showToc'])
defineProps({
  title: {
    type: String,
    default: 'ViPress'
